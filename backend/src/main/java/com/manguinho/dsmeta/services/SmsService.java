...
//@Value gets the environment variable on application.reources
	@Value("${twilio.sid}")
	...
	public void sendSms(Long saleId) {
		...
		String msg = "Vendedor " + sale.getSellerName() +
					 ", você teve " + sale.getDeals().toString() + " vendas, " +
					 sale.getVisited().toString() + " visitas, com um total de R$ " + 
					 String.format("%.2f", sale.getAmount()) + " em " + date;
